...
//  WeatherForecast
//
//  Created by Karthik Basavaraj on 14/11/15.
...
var fbContentTitle : String = ""

var fbContentDesc : String = ""

class FirstScreen: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    
    var selectedState : String = "Select"
    
    var path : String = "http://cs-server.usc.edu:14131/HW8/index.php?"
    ...
    var statesName : [String] = ["Select","Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","District Of Columbia","Florida","Georgia","Hawaii","Idaho","Illinois","Indiana","Iowa","Kansas","Kentucky","Louisiana","Maine","Maryland","Massachusetts","Michigan","Minnesota","Mississippi","Missouri","Montana","Nebraska","Nevada","New Hampshire","New Jersey","New Mexico","New York","North Carolina","North Dakota","Ohio","Oklahoma","Oregon","Pennsylvania","Rhode Island","South Carolina","South Dakota","Tennessee","Texas","Utah","Vermont","Virginia","Washington","West Virginia","Wisconsin","Wyoming"]
    var statesValue : [String] = ["Select","AL","AK","AZ","AR","CA","CO","CT","DE","DC","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY"]
    ...
    override func viewWillDisappear(animated: Bool) {
       /* let defaults : NSUserDefaults = NSUserDefaults.standardUserDefaults()
        let straddr : String = streetAddress.text!
        defaults.setObject(straddr, forKey: "streetaddr")
        let cityName : String = city.text!
    ...
    override func viewWillAppear(animated: Bool) {
       /* let defaults : NSUserDefaults = NSUserDefaults.standardUserDefaults()
        if((defaults.stringForKey("streetaddr")) != nil){
            streetAddress.text = defaults.stringForKey("streetaddr")
        }
        else{
            streetAddress.text = ""
        }
        if((defaults.stringForKey("cityname")) != nil){
            city.text = defaults.stringForKey("cityname")
        }else{
            city.text = ""
        }
        if((defaults.integerForKey("picker")) != 0){
            state.selectRow(defaults.integerForKey("picker"), inComponent: 0, animated: true)
        }
        else{
            state.selectRow(defaults.integerForKey("picker"), inComponent: 0, animated: true)
        }*/
    ...
    @IBAction func Search(sender: AnyObject) {
        ...
        if(streetAddress.text!.stringByTrimmingCharactersInSet(NSCharacterSet.whitespaceCharacterSet()) == ""){
            ...
            fbContentTitle = "Current Weather in "+self.city.text!.stringByTrimmingCharactersInSet(NSCharacterSet.whitespaceCharacterSet())+", "+self.selectedState
        }
        ...
        if(flag){
            ...
            session.dataTaskWithURL(url, completionHandler: { ( data: NSData?, response: NSURLResponse?, error: NSError?) -> Void in
                ...
                do {
                    ...
                    fbContentDesc = summary+", "+currentTemp
                    if(degree == "Fahrenheit"){
                        fbContentDesc+=" \u{00B0}F"
                    }
                    else{
                        fbContentDesc+=" \u{00B0}C"
                    }
                    ...
                    var iconurl : String = ""
                    iconurl="http://cs-server.usc.edu:14131/HW8/images/"+icon+".png"
                    ...
                    for(var i = 0 ; i<hourly.count;i++){
                       ...
                       // print(hourlyIcon)
                        ...
                        hourlyIconUrl="http://cs-server.usc.edu:14131/HW8/images/"+hourlyIcon+".png"
                        //print(hourlyIconUrl)
                   ...
                   /* for data:hourlyData in hourlyDetails{
                    ...
                    //Parse data for the next 7 days
                    for(var i=1;i<daily.count;i++){
                        ...
                        weeklyIconUrl="http://cs-server.usc.edu:14131/HW8/images/"+weeklyIcon+".png"
                        //print(weeklyIconUrl)
